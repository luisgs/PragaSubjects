...
//                        return atrib;
                     ...
                     try{
                            fichero.writeBytes("FIN OCUPACION SALA\n");
...
try{
                            ...
                            if (sdisp.Long_Salas() == 0) {
                             fichero.writeBytes("ERROR: no hay salas disponibles del " + SDiaReunioni + "-" + SMesReunioni
                                               + "-" +fi.get(Calendar.YEAR) + " al "  + SDiaReunionf + "-"
                                               + SMesReunionf + "-" +ff.get(Calendar.YEAR)+ "en Mostrar Disponibilidad Salas\n");
                            }
                            else {
                   ...
                   for (int i=0; i<fact.Dar_Long();i++) {
                    ...
                    try{
                        ...
                        String stotal = Integer.toString(total);
                         if (stotal.length() == 1)
                         ...
                         else if  (stotal.length() == 4)
                                {
                                          stotal = "000"+ stotal;
                                }
                         else if  (stotal.length() == 5)
                                {
                                          stotal = "00"+ stotal;
                                }
                            ...
                            fichero.writeBytes("Total: " + stotal +"\n");
